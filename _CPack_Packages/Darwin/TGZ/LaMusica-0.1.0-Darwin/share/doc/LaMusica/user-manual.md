...
controller lanes can be edited independently from notes through undoable commands. MIDI recording
...
render automation points without changing note selection.
...
geometry for reload. Automation playback supports read, write, touch, latch, trim, and off modes.

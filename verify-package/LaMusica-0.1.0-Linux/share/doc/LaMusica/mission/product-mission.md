...
- Primary application and DSP: C++23 for LaMusica-owned code with JUCE 8, while keeping JUCE/plugin SDK boundaries compatible with verified toolchain requirements.
